...
export interface NftPassInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "burn"
      | "burnBatch"
...
export interface NftPass extends BaseContract {
  connect(runner?: ContractRunner | null): NftPass;
  waitForDeployment(): Promise<this>;

  interface: NftPassInterface;
  ...
  setNewPrice: TypedContractMethod<
