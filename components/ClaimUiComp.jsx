...
const ClaimUiComp = ({title, desc, linkName, link, image}) => {
    return (
        <div className="flex flex-col gap-3 items-center bg-white text-center max-lg:p-4 p-9 rounded-[5px]">
...

            {
                ...
                <div className="flex justify-start mt-3 ">
                    <Link href={link} className='bg-[#0045AD] flex align-middle text-white px-5 py-2 rounded-[4px]'>Send Reward</Link>
                </div>
            }
        </div>
    )
