const AdminNFTTable = ({data, title}) => {
    
    return (
        <div>
            <div className="min-w-full bg-white p-2 px-4 border rounded-[5px] mt-5 max-lg:overflow-scroll">
                <h2 className="font-bold text-[1.2rem]">{`${title} NFT Minting and Claiming`}</h2>
                <table className="min-w-full bg-white p-11 mt-4">
                    <thead>
                        <tr className="border-b border-gray-300">
                            ...
                            <th className="font-semibold text-[#6E7887] pb-3">NFT Type</th>
                        ...
                        
                        {
                            data.map((detail, index) => (
                                <tr className="p-2" key={index}>
                                    ...
                                    <td className="text-center py-4 max-lg:border-r">{(detail.nft)}</td>
