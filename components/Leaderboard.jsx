...
class Leaderboard extends Component {
    ...
    render() {
        ...
        const {title, heading, subheading} = this.props
        ...
        return (
            <div className="max-lg:my-[1em] my-[2em] px-[10%] text-center res-pad-in">
                ...
                <div className="flex justify-center mt-3">
                    <Link href="#" className='bg-white border border-[#0045AD] flex align-middle text-[#0045AD] px-5 py-2 rounded-[4px] hover:bg-[#0045AD] hover:text-white'>View more</Link>
                </div>
            </div>
        )
    }
