	...
	return (
		<header className="header fixed top-0 right-0 left-0 border-b z-10 bg-white flex justify-between items-center px-[10%] py-2">
			...
			<div className="desktop middle w-[50%] flex justify-around">
				<Link
					className={`link hover:text-[#0045AD] ${
						pathname === "/" ? "text-[#0045AD]" : ""
					}`}
					href="/"
				>
					Home
				...
				<div className="relative link flex items-center">
					Play{" "}
					<i
						className="bx bx-chevron-down text-[1.2rem] ml-2"
					...
					{playDropdown && (
						<div className="absolute top-[120%] bg-white border w-[12rem] rounded-md">
							<Link
								href="/denary"
								className="block px-4 py-2 border-b hover:bg-[#0045AD] hover:text-white"
								onClick={togglePlayDropdown}
							>
								Denary
							</Link>
				...
				<Link
					className={`link hover:text-[#0045AD] ${
						pathname === "/leaderboard" ? "text-[#0045AD]" : ""
					}`}
					href="/leaderboard"
				>
					Leaderboard
			...
			{active && (
				<div className="mobile middle w-[50%] flex justify-around">
					...
					<div
						className={`link relative hover:text-[#0045AD] ${
							pathname === "/denary" ? "text-[#0045AD]" : ""
						}`}
					>
						Play{" "}
						<i
							className="bx bx-chevron-down text-[1.2rem] ml-2"
							onClick={togglePlayDropdownMobile}
						></i>
						{playDropdownMobile && (
