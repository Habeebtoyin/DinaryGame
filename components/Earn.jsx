        ...
        <div className="recent shadow-md rounded-[4px] p-6 bg-white max-lg:w-[100%] w-[48%]">
            ...
            <div className="mt-[2em]">
                <div>
                    ...
                    <p className="mb-3">
                        You can burn your Master NFT to earn ETH and Legendary NFTs. The More Master NFTs you burn, the more rewards you will earn
                    </p>
                    <p className="mb-3">
                    ...
                    <p className="mb-3">
                        To burn your Master NFTs, you need to go to the indices game dashboard and connect your wallet then click on Score Page. Once your wallet is connected, you will be able to burn your NFT right in the Score Page
                    </p>

                    <p className="mb-3">
                        1. Go to the Indices game site and connect your wallet <br />
                        2. Click on the Score menu <br />
                        3. Click on the "Burn NFT" if yo have the Master NFTs up to 3, 6 or 9 <br />
                        4. Burning removes the NFT and gives you the popup to mint Legendary NFT and claim the corresponding reward.
                    </p>
