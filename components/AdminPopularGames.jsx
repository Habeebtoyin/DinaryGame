		...
		<div className="bg-white border border-slate-300 p-5 rounded-[5px] w-[28%] max-lg:w-[100%]">
			...
			<div className="grid max-lg:grid-cols-1 grid-cols-2 gap-6 my-[1em]">
				<div className="flex items-center">
					<p className="bg-[#EA8D26] px-3 py-1 text-center text-white rounded-sm">
						A
					</p>
					<p className="ml-3">Denary</p>
				</div>
				<div className="flex items-center">
					<p className="bg-[#59E6F6] px-3 py-1 text-center text-white rounded-sm">
						B
					</p>
					<p className="ml-3">PVP</p>
				</div>
				<div className="flex items-center">
					<p className="bg-[#0045AD] px-3 py-1 text-center text-white rounded-sm">
						C
					</p>
